...
const Home = ({ collections }: Props) => {
  return (
    <div className="max-w-7xl mx-auto flex-col flex min-h-screen py-20 px-10 2xl:px-0">
      <Head>
        <title>Artifcation</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <h1 className="mb-10 text-4xl font-extralight">The{' '}<span className="font-extrabold underline decoration-pink-600/50">ARTIFACTION</span>{' '}NFT Market Place</h1>
        ...
        <div className="grid space-x-3 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
          {collections.map(collection => (
            ...
            <div className="flex flex-col items-center cursor-pointer transition-all duration-200 hover:scale-105">
              ...
              <div className="p-5">
                <h2 className="text-black text-3xl">{collection.title}</h2>
