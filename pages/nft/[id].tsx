    ...
    <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
        ...
        <div className="lg:col-span-4 bg-gradient-to-br from-cyan-800 to-rose-500">
            <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
                ...
                <div className="space-y-2 p-5 text-center">
                    <h1 className="text-4xl font-bold text-white">ARTIFACTION Apes</h1>
                    <h2 className="text-xl text-gray-300">A collection of ARTIFACTION Apes who live & breathe React!</h2>
                </div>
            </div>
        </div>
        ...
        <div className="flex flex-1 flex-col p-12 lg:col-span-6">
            ...
            <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:space-y-0 lg:justify-center">
                ...
                <h1 className="text-3xl font-bold lg:text-5xl lg:font-extrabold">The ARTIFACTION Ape Coding Club | NFT Drop</h1>
